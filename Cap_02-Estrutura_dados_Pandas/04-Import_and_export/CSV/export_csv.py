...
# --- 4. Modificando o DataFrame ---

# Remove a linha com índice 2 (axis=0) e armazena o resultado em um NOVO DataFrame
df_modificada = df.drop(index=2, axis=0)

# --- 5. Exportando o DataFrame Modificado ---

# Salva o DataFrame modificado (sem a linha 2) em um novo arquivo CSV
df_modificada.to_csv('scientists_modificado.csv')