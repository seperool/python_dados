...
![Uma versão mais nova da representação de "Parts of a Figure", com mais detalhes sobre outros aspectos de uma figura. De modo diferente da figura antiga, a figura mais recente foi totalmente criada com a `matplotlib`.](./Imagens/Cap_03-Introducao_plotagem/matplotlib-nova_partes_firgura.png){width=400}
