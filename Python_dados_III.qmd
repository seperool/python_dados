...
* `Series.cat.set_categories()`:
  ...
  É a função "faz-tudo". Com ela, você pode adicionar, remover e ordenar categorias de uma só vez, definindo exatamente como a lista final deve ser.
...
* `Series.cat.as_unordered()`:
  ...
  Retira a hierarquia. As categorias passam a ser apenas nomes diferentes, sem relação de grandeza entre elas.
