...
Para formatar strings de caracteres, você deve essencialmente escrever string com caracteres [placeholders especiais]{.underline} e [usar o método `format` na string para inserir valores nesses placeholders]{.underline}.
